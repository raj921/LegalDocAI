...
class GeminiService:
    def __init__(self):
        # Create client - it automatically picks up API key from GEMINI_API_KEY or GOOGLE_API_KEY env var
...
Return ONLY valid JSON, no other text."""
    ...
    def generate_embedding(self, text: str) -> List[float]:
        try:
            # New SDK embedding call with task_type to get consistent 768 dimensions
